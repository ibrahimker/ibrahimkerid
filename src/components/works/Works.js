...
import w1image from '../../assets/img/work/w1.jpg';
import w2image from '../../assets/img/work/w2.jpg';
import w3image from '../../assets/img/work/w3.jpg';
import w4image from '../../assets/img/work/w4.jpg';
            ...
            <div className="row grid">
              <div className="single-work col-lg-4 col-md-6 col-sm-12 all creative wow fadeInUp" data-wow-duration="2s">
                <div className="relative">
                  <div className="thumb">
                    ...
                    <img className="image img-fluid" src={w1image} alt=""/>
                  </div>
              ...
              <div className="single-work col-lg-4 col-md-6 col-sm-12 all web-design branding wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                <div className="relative">
                  <div className="thumb">
                    <div className="overlay overlay-bg"></div>
                    <img className="image img-fluid" src={w2image} alt=""/>
                  </div>
                  <div className="middle">
                    <h4>2D Vinyl Design</h4>
                    <div className="cat">Client Project</div>
              ...
              <div className="single-work col-lg-4 col-md-6 col-sm-12 all branding web-design wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
                <div className="relative">
                  <div className="thumb">
                    <div className="overlay overlay-bg"></div>
                    <img className="image img-fluid" src={w3image} alt=""/>
                  </div>
                  <div className="middle">
                    <h4>2D Vinyl Design</h4>
                    <div className="cat">Client Project</div>
              ...
              <div className="single-work col-lg-4 col-md-6 col-sm-12 all creative wow fadeInUp" data-wow-duration="2s">
                <div className="relative">
                  <div className="thumb">
                    <div className="overlay overlay-bg"></div>
                    <img className="image img-fluid" src={w4image} alt=""/>
                  </div>
                  <div className="middle">
                    <h4>2D Vinyl Design</h4>
                    <div className="cat">Client Project</div>
